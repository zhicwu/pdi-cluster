...
public class ExcelWriterStep extends BaseStep implements StepInterface {
    ...
    public static void copyFile(FileObject in, FileObject out) throws KettleException {
        try {
            copyFileContent(KettleVFS.getInputStream(in), KettleVFS.getOutputStream(out, false));
        } catch (KettleException e) {
            throw e;
        } catch (Exception e) {
            throw new KettleException(e);
    ...
    public static void copyFileContent(InputStream in, FileObject out) throws KettleException {
        try {
            copyFileContent(in, KettleVFS.getOutputStream(out, false));
        } catch (KettleException e) {
            throw e;
        } catch (Exception e) {
            throw new KettleException(e);
    ...
    public static void copyFileContent(InputStream in, OutputStream out) throws KettleException {
        ...
        try {
            ...
            if (!data.file.exists()) {
                ...
                if (meta.isTemplateEnabled()) {
                    ...
                    String templateExt = fileMeta.isAvailable() ? ResourceDefinitionHelper.extractExtension(fileMeta.getFileName())
                            : KettleVFS.getFileObject(data.realTemplateFileName).getName().getExtension();
                    ...
                    if (fileMeta.isAvailable() || KettleVFS.getFileObject(data.realTemplateFileName).exists()) {
                        if (fileMeta.isAvailable()) {
                            copyFileContent(fileMeta.getBinaryInputStream(), data.file);
                        } else {
