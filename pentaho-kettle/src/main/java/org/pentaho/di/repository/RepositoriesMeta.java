...
public class RepositoriesMeta {
    ...
    public RepositoryMeta findRepository(String name) {
        ...
        log.logError(new StringBuilder().append("Repository [name=").append(name)
                .append("] was not found within ").append(nrRepositories()).append(" repositories.").toString());
    ...
    public RepositoryMeta findRepositoryById(String id) {
        ...
        log.logError(new StringBuilder().append("Repository [id=").append(id)
                .append("] was not found within ").append(nrRepositories()).append(" repositories.").toString());
